class AddCachedVotesOnAlbumsAndArtists < ActiveRecord::Migration
  def up
    ...
    add_column :artists, :cached_votes_total, :integer, :default => 0
    ...
    add_index  :artists, :cached_votes_total
  ...
  def down
    ...
    remove_column :artists, :cached_votes_total
